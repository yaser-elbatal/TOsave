...
import { List_Items } from '../../../../services/queries/Maintainance/MaintainanceReports/Items';
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        ...
        >
          عناصر تصنيف {this.state.qString.name} لتقارير الصيانة
        </div>
        <Row>
          <Col xl={12}>
                        ...
                        <Card>
                          ...
                          <CardBody>
                            <Table responsive hover style={{ textAlign: "center" }}>
                              ...
                              <tbody>
                                {
                                  data.maintainance_items.map((item, index) => {
                                    if (!item.isNeglected)
                                      return <this.ItemRow key={index} index={index + 1} item={item} />
                                  })
                                }
                              </tbody>
                            </Table>
