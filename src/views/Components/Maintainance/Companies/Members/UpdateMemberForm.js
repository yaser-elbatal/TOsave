        ...
        return (
            <Form>
                <FormGroup>
                    ...
                    <Input type="text" name="username" onChange={this.changeHandle} defaultValue={this.props.data.username} id="username" placeholder="اسم الموظف" />
                </FormGroup>
                <FormGroup>
                    <Label for="display_name">الاسم المعروض</Label>
                    <Input type="text" name="display_name" onChange={this.changeHandle} defaultValue={this.props.data.display_name} id="display_name" placeholder="الاسم المعروض" />
                </FormGroup>
                <FormGroup>
